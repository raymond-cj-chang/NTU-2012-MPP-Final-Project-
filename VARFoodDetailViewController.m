...
- (IBAction)segmentedControlIndexChanged:(id)sender {
    ...
    switch (index) {
        ...
        case 2:
            ...
            break;
        case 3:
            [self performSegueWithIdentifier:@"showMap" sender:self.segmentedControl];
            break;
        default:
            break;
    }
    ...
    if ([buttonTitle isEqualToString:@"Send"]) {
        for (UIView* view in alertView.subviews)
        {
            if ([view isKindOfClass:[UITextField class]])
            {
                ...
                [[VARMenuDataSource sharedMenuDataSource] uploadCommentToGAEServer:fid withComment:self.comment updateFood:TRUE];
...
- (void) updateNewVote{
    ...
    [[VARMenuDataSource sharedMenuDataSource] uploadFoodRatingToGAEServer:_food[VARsDataSourceDictKeyFoodID] updateFood:TRUE];
