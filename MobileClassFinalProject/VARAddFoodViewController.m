...
#warning fix Chinese Category
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        [[VARMenuDataSource sharedMenuDataSource] uploadCommentToGAEServer:fidStr withComment:foodComment updateFood:FALSE];
        
        //add image
        [[VARMenuDataSource sharedMenuDataSource] uploadFoodImageToGAEServer:fidStr withImageName:nil withImage:foodImage updateFood:TRUE];
        
        //***** need all upload finish then download****
        //download from server
        if(foodImage==nil) [[VARMenuDataSource sharedMenuDataSource] downloadFoodDataFromGAEServer];
        //[[VARMenuDataSource sharedMenuDataSource] downloadFoodDataFromGAEServer];
