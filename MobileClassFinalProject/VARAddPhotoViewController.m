...
- (IBAction)sendButton:(id)sender {
    ...
    if(self.imageView.image!=nil) [[VARMenuDataSource sharedMenuDataSource] uploadFoodImageToGAEServer:_food[VARsDataSourceDictKeyFoodID] withImageName:nil withImage:self.imageView.image updateFood:TRUE];
}
